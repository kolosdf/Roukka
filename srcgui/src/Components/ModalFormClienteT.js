...
function ModalFormClienteT(props) {
                ...
                <Card className="shadow-none border-0">
                    <div className="card-header d-block bg-first text-white pt-5 pb-5 ">
                        ...
                        <div className="text-center">
                            <FontAwesomeIcon icon={['fas', 'user-tie']} size="3x" /> <h1>{datosForm.titulo}</h1>
                        </div>
                    </div>
...
export default ModalFormClienteT;